...
class MhSaExtractor(BaseFeaturesExtractor):
    ...
    def __init__(self, observation_space, max_ents=0, entity_keys={}, nonent_features=64, ent_features=16, activation=F.tanh, sa_heads=4):
...
policy_kwargs = dict(features_extractor_class=MhSaExtractor, features_extractor_kwargs=dict(max_ents=n_heals, entity_keys=entity_keys))
